...
from ..snpmiso.ops.modules import MSDeformAttn
...
class DeformableTransformer(nn.Module):
    ...
    def forward(self, srcs, masks, pos_embeds):
        ...
        return memory.permute(1, 2, 0).reshape(bs, c, h, w)
...
def build_deforamble_transformer(args):
    return DeformableTransformer(
        d_model=args.hidden_dim1,
        nhead=args.nheads,
        num_encoder_layers=args.def_enc_layers,
        dim_feedforward=args.def_dim_feedforward,
