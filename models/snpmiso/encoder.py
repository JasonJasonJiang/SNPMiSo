...
class DilatedEncoder(nn.Module):
    ...
    def __init__(self, 
        ...
        self.projector = nn.Sequential(
            ...
            # Conv(in_dim, out_dim, k=3, p=1, s=st, act_type=None, norm_type=norm_type)
            Conv(out_dim, out_dim, k=3, p=1, s=st, act_type=None, norm_type=norm_type)
...
# build encoder
def build_encoder(cfg, in_dim, out_dim, st, dl):
    print('==============================')
